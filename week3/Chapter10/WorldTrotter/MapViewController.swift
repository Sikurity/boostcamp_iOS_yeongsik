...
class MapViewController: UIViewController {
    ...
    func addChangeMapStatusSegment() -> UISegmentedControl{
        ...
        let segment = UISegmentedControl(items: [standardString, hybridString, satelliteString])
    ...
    func addGotoUserLocationButton() -> UIButton {
        ...
        let gotoCurrentLocationString = NSLocalizedString("Go to current location", comment: "Go to current location")
        
        let button = UIButton()
        button.setTitleColor(UIColor.black, for: .normal)
        
        button.setTitle(gotoCurrentLocationString, for: .normal)
    ...
    func addShowNextPinButton() -> UIButton {
        ...
        let showMemorizedLocationString = NSLocalizedString("Show Memorized Location", comment: "Show memorized location")
        
        let button = UIButton()
        button.setTitleColor(UIColor.black, for: .normal)
        
        button.setTitle(showMemorizedLocationString, for: .normal)
        button.translatesAutoresizingMaskIntoConstraints = false
    ...
    func gotoUserLocation(_ sender: Any) {
        ...
        // 사용자 위치를 받아오고, 그럴 수 없다면 에러 출력
        guard let locationCoord = mapView.userLocation.location?.coordinate
            else { print("No Location"); return}
        
        setRegion(of: mapView, to: locationCoord)
    }
    ...
    func showNextPins(_ sender: Any) {
        let birthLocationString = NSLocalizedString("Location In Birth", comment: "Location in birth")
        let boostcampString = NSLocalizedString("Boostcamp", comment: "Location of boostcamp")
        let interestingLocationString = NSLocalizedString("Interestiong Location", comment: "Interestiong Location")
        let gotoNextPinString = NSLocalizedString("Go To Next Pin", comment: "Go to next pin")
